...
(function() {
  document.addEventListener("turbolinks:load", function() {
    return $(".language-point").click(function() {
      switch (this.text) {
        case "English":
        case "Английский":
          return Cookies.set("language", "en");
        case "Russian":
        case "Русский":
          return Cookies.set("language", "ru");
      }
    });
  });
...
(function() {
  document.addEventListener("turbolinks:load", function() {
    return $("#theme").click(function() {
      if ($(this).prop("checked")) {
        Cookies.set("theme", "true");
        $(this).attr("checked", true);
        return $("body").attr("class", "dark-theme");
      } else {
        Cookies.set("theme", "false");
        $(this).attr("checked", null);
        return $("body").attr("class", "light-theme");
      }
    });
  });
